...
import InputAria1 from './components/InputAria1';
import OutputAria from './components/OutputAria';
import OutputAria1 from './components/OutputAria1';
...
export default function Home() {
  ...
  return (
    ...
    <InputAria1 onProductChange={handleProductChange}/>
    <OutputAria1 productid={productid}/>
    </>
  );
}